...
Open the folder for the figure or supplementary table you want to reproduce.

Set the R working directory to that folder, if needed.

Run the corresponding .R script.
